    ...
    <div className="flex flex-col gap-6">
      ...
      <Tabs defaultValue="general" className="w-full">
        <TabsList className="bg-secondary border border-border">
          <TabsTrigger value="general" className="data-[state=active]:bg-card data-[state=active]:text-foreground text-muted-foreground">
            General
          </TabsTrigger>
          ...
          <TabsTrigger value="integrations" className="data-[state=active]:bg-card data-[state=active]:text-foreground text-muted-foreground">
            Integrations
          </TabsTrigger>
          <TabsTrigger value="security" className="data-[state=active]:bg-card data-[state=active]:text-foreground text-muted-foreground">
            Security
          </TabsTrigger>
        </TabsList>
          ...
          <Card className="bg-card border-border">
            <CardHeader>
              ...
              <CardDescription className="text-muted-foreground">
                Configure your scanning preferences and defaults.
              </CardDescription>
            </CardHeader>
            <CardContent className="flex flex-col gap-6">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-foreground">AI-Powered Remediation</p>
                  <p className="text-xs text-muted-foreground">Generate fix suggestions using AI for each vulnerability</p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Enable Slither and Mythril for Solidity contracts</p>
                </div>
                ...
                <div key={integration.name} className="flex items-center justify-between p-3 rounded-lg border border-border bg-secondary/30">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      {integration.account || "Click connect to set up"}
                    </p>
                  </div>
                  <Button
                    size="sm"
            ...
            <CardContent className="flex flex-col gap-6">
              <div className="flex flex-col gap-2">
                ...
                <div className="flex gap-2">
                  <Input
                    value="sk-appscan-xxxx-xxxx-xxxx-xxxxxxxxxxxx"
                    readOnly
                  ...
                  <Button
                    ...
                    onClick={() => {
                      navigator.clipboard.writeText("sk-appscan-xxxx-xxxx-xxxx-xxxxxxxxxxxx")
              ...
              <div className="flex items-center justify-between p-3 rounded-lg border border-destructive/30 bg-destructive/5">
                ...
                <Button
                  ...
                  onClick={() => toast.error("Account deletion cancelled", { description: "This is a demo." })}
                >
